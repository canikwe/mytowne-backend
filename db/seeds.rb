...
Post.all[Post.all.length - 1].tags = [Tag.all.sample, Tag.all.sample].uniq
Post.all[Post.all.length - 2].tags = [Tag.all.sample, Tag.all.sample].uniq
Post.all[Post.all.length - 3].tags = [Tag.all.sample, Tag.all.sample].uniq
Post.all[Post.all.length - 4].tags = [Tag.all.sample, Tag.all.sample].uniq
Post.all[Post.all.length - 5].tags = [Tag.all.sample, Tag.all.sample].uniq
